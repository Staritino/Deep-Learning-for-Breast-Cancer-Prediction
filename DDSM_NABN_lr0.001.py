...
train_data_dir = '/scratch/star/SCRIP/N_ABN/trainTF_JPG'
validation_data_dir = '/scratch/star/SCRIP/N_ABN/valTF_JPG'
test_data_dir = '/scratch/star/SCRIP/N_ABN/testTF_JPG'
train_samples = 10020
validation_samples = 2147
test_samples = 2149
#epochs = 10
batch_size = 100
...
saveto = 'images/'
#plt.show
plt.savefig(saveto + 'NABN_DDVplot5.png')
...
saveto = 'images/'
#plt.show
plt.savefig(saveto + 'N_ABNDDVplot6.png')
