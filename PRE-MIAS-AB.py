...
IMG_DIR = 'all-mias1/Abnormal'
if not os.path.exists('all-mias1/Abnormal/Thresholded2/'):
    SAVE_DIR = os.makedirs('all-mias1/Abnormal/Thresholded2/')
else:
    SAVE_DIR = 'all-mias1/Abnormal/Thresholded2/'
