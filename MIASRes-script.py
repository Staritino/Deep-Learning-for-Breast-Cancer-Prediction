...
train_data_dir = '/scratch/star/SCRIP/all-mias1/trainall-mias1'
validation_data_dir = '/scratch/star/SCRIP/all-mias1/valall-mias1'
test_data_dir = '/scratch/star/SCRIP/all-mias1/testall-mias1'
train_samples = 224
...
for layer in base_model.layers[:161]:
    layer.trainable = False
for layer in base_model.layers[161:]:
...
model.compile(optimizer=SGD(lr=0.0001, momentum=0.8), loss='sparse_categorical_crossentropy', metrics=["accuracy"])
...
saveto = 'images/'
#plt.show
plt.savefig(saveto + 'RR2plot4.png')
...
saveto = 'images/'
#plt.show
plt.savefig(saveto + 'RR2plot5.png')
...
plt.title('ROC curve')
plt.legend(loc='best')
plt.savefig(saveto + 'RR2plot6.png')
